    ...
    <div className="statistic__bottom">
      <Card className="statistic__bottom-card statistic__bottom-card-purple">
        ...
        <p>
          ...
          и&nbsp;долгосрочной стабильности. Инвестиции позволяют вашим средствам
          работать на&nbsp;вас, преодолевать инфляцию и&nbsp;создавать основу
      ...
      <Card className="statistic__bottom-card">
        ...
        <p>
          Повышаем финансовую грамотность: учимся управлять бюджетом, прощаться
          с&nbsp;долгами и&nbsp;инвестировать
        </p>
