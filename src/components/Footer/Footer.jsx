      ...
      <div className='direction container'>
        <div className='direction__wrapper'>
          ...
          <section className='direction__social'>
            ...
            <div className='direction__card'>
              <ul className='birection__list list-reset'>
                <li className='direction__item direction__item-strategies'>
                  Автоследование
                  <span className='direction__indicator'>
                    +97%
                ...
                <li className='direction__item direction__item-strategies'>
                  Комон
                  <spana className='direction__indicator'>
                    +97%
                    <span className='span-light'>за год</span>
                  </spana>
                </li>
        ...
        <div className='direction__contact'>
          ...
          <p className='direction__text'>
            Пользовательское соглашение Соглашение на&nbsp;обработку
            персональных данных Политика конфиденциальности Публичная оферта
          </p>
        </div>
      </div>
